...
import test "github.com/eran-indegy/mockery/mockery/fixtures"
...
func (s *GeneratorSuite) TestGeneratorPrologueNote() {
	generator := s.getGenerator(testFile, "Requester", false)
	generator.GeneratePrologueNote("0", "A\\nB")

	expected := `// Code generated by mockery v1.1.0. hash:0; DO NOT EDIT.
